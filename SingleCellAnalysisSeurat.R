...
pbmc.data <- Read10X_h5("/home/hice1/bli629/biol6150/ProjectSubmissions/Group23/Project7/10k_PBMC_3p_nextgem_Chromium_X_intron_raw_feature_bc_matrix.h5")
...
VlnPlot(pbmc, features = c("FHIT", "CAMK4", "PRKCA", "BACH2"), slot = "counts", log = TRUE)
